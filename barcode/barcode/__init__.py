...
__project__ = 'barcode passes'
__author__ = 'Bharat Rajani'
__author_email__ = 'bharat.ramrajani@gmail.com'
...
__license__ = 'MIT'
__url__ = 'https://github.com/bharat-rajani/Project-barcode-passes'
__classifiers__ = [
